...
const contactSchema = yup.object({
  ...
  name: yup.string().required("Name is reuire"),
  mobile: yup.string().required("Mobile number is reuire"),
  comment: yup.string().required("comment is reuire"),
});
  ...
  return (
    <>
      <div className="bg-gray-200">
        ...
        <BredCrum title="Contact Us" />

        <div className="flex justify-center  m-16">
          <iframe
            title="Interactive Map of Our Campus"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d235013.74842400278!2d72.41492542452872!3d23.02047410440972!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e848aba5bd449%3A0x4fcedd11614f6516!2sAhmedabad%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1712816093729!5m2!1sen!2sin"
            width="1250"
            height="500"
            style={{ border: 0 }}
            loading="lazy"
                ...
                <div className="mt-6 space-y-8 md:mt-8">
                  <p className="flex items-start -mx-2">
                    ...
                    <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">
                      Fortune Plaza, Nikol, Ahmedabad, India
                    </span>
                  </p>
